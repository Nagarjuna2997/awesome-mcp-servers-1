...
- [iOS Agent Skill](https://github.com/Nagarjuna2997/ios-agent-skill) - Swift project reviews, local Apple references, app scaffolding and iOS Simulator workflows through a unified MCP server. Simulator tools require macOS and Xcode.
